...
const (
	...
	HelloService_SayManyHellosToEveryone_FullMethodName = "/hello.HelloService/SayManyHellosToEveryone"
)
...
type HelloServiceClient interface {
	...
	SayManyHellosToEveryone(ctx context.Context, opts ...grpc.CallOption) (HelloService_SayManyHellosToEveryoneClient, error)
}
...
func (c *helloServiceClient) SayManyHellosToEveryone(ctx context.Context, opts ...grpc.CallOption) (HelloService_SayManyHellosToEveryoneClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &HelloService_ServiceDesc.Streams[2], HelloService_SayManyHellosToEveryone_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &helloServiceSayManyHellosToEveryoneClient{ClientStream: stream}
	return x, nil
}

type HelloService_SayManyHellosToEveryoneClient interface {
	Send(*HelloRequest) error
	Recv() (*HelloResponse, error)
	grpc.ClientStream
}

type helloServiceSayManyHellosToEveryoneClient struct {
	grpc.ClientStream
}

func (x *helloServiceSayManyHellosToEveryoneClient) Send(m *HelloRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *helloServiceSayManyHellosToEveryoneClient) Recv() (*HelloResponse, error) {
	m := new(HelloResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type HelloServiceServer interface {
	...
	SayManyHellosToEveryone(HelloService_SayManyHellosToEveryoneServer) error
...
func (UnimplementedHelloServiceServer) SayManyHellosToEveryone(HelloService_SayManyHellosToEveryoneServer) error {
	return status.Errorf(codes.Unimplemented, "method SayManyHellosToEveryone not implemented")
}
...
func _HelloService_SayManyHellosToEveryone_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(HelloServiceServer).SayManyHellosToEveryone(&helloServiceSayManyHellosToEveryoneServer{ServerStream: stream})
}

type HelloService_SayManyHellosToEveryoneServer interface {
	Send(*HelloResponse) error
	Recv() (*HelloRequest, error)
	grpc.ServerStream
}

type helloServiceSayManyHellosToEveryoneServer struct {
	grpc.ServerStream
}

func (x *helloServiceSayManyHellosToEveryoneServer) Send(m *HelloResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *helloServiceSayManyHellosToEveryoneServer) Recv() (*HelloRequest, error) {
	m := new(HelloRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var HelloService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "SayManyHellosToEveryone",
			Handler:       _HelloService_SayManyHellosToEveryone_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
